...
@interface Raycasting3DTestObject : KrollCoverageObject {
#else
@interface Raycasting3DTestObject : KrollObject {
#endif
@private
...
extern NSString * Raycasting3DTest$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Raycasting3DTestObject *_raycasting3dtest;
    KrollObject* console;
	BOOL shutdown;
