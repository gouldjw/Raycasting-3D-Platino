...
/**
 Base class for all Raycasting3DTest views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Raycasting3DTest view hierarchy (such as wrapped iOS UIViews) was touched.
