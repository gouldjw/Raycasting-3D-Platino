...
//@interface Raycasting3DTestObject : NSObject
//@end

@interface Raycasting3DTestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Raycasting3DTestObject class]])
		{
			for (NSString *key in [[(Raycasting3DTestObject*)o modules] allKeys])
			{
