...
/**
 The base class for all Raycasting3DTest modules
 */
...
/**
 Raycasting3DTest Platform calls this method on startup.
 */
-(void)startup;

/**
 Raycasting3DTest Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Raycasting3DTest Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Raycasting3DTest Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Raycasting3DTest Platform calls this method on resume.
 @param sender The sender of the event.
 */
