...
//Rare exceptions to indicate a bug in the _raycasting3dtest code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Raycasting3DTest proxies.
 */
