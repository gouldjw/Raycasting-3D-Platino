...
// in simulator we redefine to format for Raycasting3DTest Developer console
...
{\
	NSString * exceptionName = [@"org.raycasting3dtest." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.raycasting3dtest";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIRaycasting3DTestNativeItemNone = -1, 
	UIRaycasting3DTestNativeItemSpinner = -2,
	UIRaycasting3DTestNativeItemProgressBar = -3,
	
	UIRaycasting3DTestNativeItemSlider = -4,
	UIRaycasting3DTestNativeItemSwitch = -5,
	UIRaycasting3DTestNativeItemMultiButton = -6,
	UIRaycasting3DTestNativeItemSegmented = -7,
	
	UIRaycasting3DTestNativeItemTextView = -8,
	UIRaycasting3DTestNativeItemTextField = -9,
	UIRaycasting3DTestNativeItemSearchBar = -10,
	
	UIRaycasting3DTestNativeItemPicker = -11,
	UIRaycasting3DTestNativeItemDatePicker = -12,
	
	UIRaycasting3DTestNativeItemInfoLight = -13,
	UIRaycasting3DTestNativeItemInfoDark = -14,
	
	UIRaycasting3DTestNativeItemDisclosure = -15,
	
	UIRaycasting3DTestNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Raycasting3DTest instances of
